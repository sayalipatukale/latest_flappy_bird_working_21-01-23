...
listener = Listener(address, authkey=b'flappy_bird_hof_eeg')
...
class Game:
	...
	def __init__(self):
		...
		pygame.time.set_timer(self.obstacle_timer,1400) #1400
	...
	def run(self):
		...
		while True:
			...
			for event in pygame.event.get():
				...
				if ((msg > 0.5) or (event.type == pygame.MOUSEBUTTONDOWN)):
					if self.active:
						print("jump")
						#eeg_headset()
						# x = middleman.mainFlap()
						# print(x)
